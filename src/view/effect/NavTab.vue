<template>
  <div class="body">
    <nav class="navtab" :style="`--active-index:${activeTab}`">
      <ul>
        <li class="navtab-item" :class="{ active: activeTab === 0 }" @click="activeTab = 0">
        ...
        <li class="navtab-item" :class="{ active: activeTab === 1 }" @click="activeTab = 1">
        ...
        <li class="navtab-item" :class="{ active: activeTab === 2 }" @click="activeTab = 2">
        ...
        <li class="navtab-item" :class="{ active: activeTab === 3 }" @click="activeTab = 3">
